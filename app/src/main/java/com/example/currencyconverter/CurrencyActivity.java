...
public class CurrencyActivity extends AppCompatActivity {
    ...
    AdapterRecycler2 adapter;
    favorites_page adapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1 = findViewById(R.id.favoritesButton);
        ...
        adapter = new AdapterRecycler2(products);
    ...
    private void getProducts(){
        ...
        for(String productName : productNames){
            Product product = new Product(productName,productImages[count],productRates[count]);
