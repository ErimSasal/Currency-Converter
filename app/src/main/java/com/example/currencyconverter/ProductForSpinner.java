...
public class ProductForSpinner {
    ...
    public ProductForSpinner(int simageId,String scurrencyName) {
        this.simageId = simageId;
        this.scurrencyName = scurrencyName;
    ...
    public void setScurrencyName(String scurrencyName) {
        this.scurrencyName = scurrencyName;
    }

    public static ArrayList<ProductForSpinner> getDataForSpinner(){

        ArrayList<ProductForSpinner> spinnerList = new ArrayList<ProductForSpinner>();
        ...
        for(int i=0;i < productImages.length;i++){
            ProductForSpinner temp = new ProductForSpinner();
            temp.setSimageId(productImages[i]);
            temp.setScurrencyName(productNames[i]);
