    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.share_button:
                ...
                String shareText = "Please choose how you share!";
...
/* JSON denemesi
    public class DownloadData extends AsyncTask<String, Void, String> {
        ...
        public void onPostExecute(String s) {
            ...
            //System.out.println("turkishliraturkishliraturkishliraturkishliraturkishliraturkishlira" + turkishlira);

            ArrayList<JSONArray> ratesList = new ArrayList<>();
            ratesList.add(rates);
            ...
            String ratesValues = gson.toJson(ratesList);
            editor.putString("ratesValues", ratesValues);
